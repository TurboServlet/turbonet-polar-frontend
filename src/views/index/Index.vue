  ...
  <div class="body">
    <section class="header shadow-2xl mb-16">
      ...
      <div class="header-all">
        ...
        <div class="container">
          <div class="big-text">
            <h1><span class="font-black bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text [-webkit-text-fill-color:transparent]">TurboNET</span><br><span style="color: oklch(var(--p))">Polar <i class="fa-solid fa-meteor"></i></span></h1>
          </div>
